...
> M9 even though every file "looks right" in isolation. (Observed: spotify-trip M9→M10.)
...
> scattered across intervening milestones. (Observed: spotify-trip M8/05.) Build the capability in the
