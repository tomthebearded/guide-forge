...
## Prerequisite
M3 complete: the zoneless `spotify-trip` app runs, `provideHttpClient()` is wired (M2), and `three` +
...
- **M0** — Zoneless `spotify-trip` Angular 21.2 project; Material 3 custom theme; ESLint/Prettier tooling; app
