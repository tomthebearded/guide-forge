...
- **M0 — Scaffold & tooling:** zoneless Angular 21 project `spotify-trip`; Material 3 "Deep Space Teal"
...
interceptor + `withRetry`, proving a paced, retried authenticated `/me` call surfaces *"You have N liked
