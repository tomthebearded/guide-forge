...
## Frontier
- **Current frontier:** the **whole guide (M1–M7) is drafted**; awaiting a human to follow it in a browser and
...
<!-- Status key: ✅ verified (Done-when passed by hand in a browser) · 📝 drafted (written, not yet run by a human) · ⚠ re-verify (content changed since last look — needs a fresh browser pass) · ⏳ in progress · ❌ not started -->
