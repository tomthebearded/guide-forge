...
| [maintenance-prompts.md](maintenance-prompts.md) | **Input.** Invocations for the auxiliaries: audit, update-stack, modernize, mark-progress, check-my-work, amend, report-issue, log-feedback, draft-qa-guide. |
